...
public class MapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        GetComponent<BoxCollider>().size = new Vector3(currentMap.mapSize.x * tileSize, 0.00001f, currentMap.mapSize.y * tileSize);
        ...
        for (int i = 0; i < obstacleCount; i++)
        {
            ...
            if (randomCoord != currentMap.mapCentre && MapIsFullyAccessible(obstacleMap, currentObstacleCount))
            {
                ...
                int randomObs = Random.Range(0, obstaclePrefab.Length);
                Transform newObstacle = Instantiate(obstaclePrefab[randomObs], obstaclePos + Vector3.up * obstacleHeight / 2, Quaternion.identity) as Transform;
